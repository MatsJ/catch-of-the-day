    ...
    render() {
        return (
            <form className="fish-edit" onSubmit={this.createFish}>
                ...
                <textarea desc="desc" ref={this.descRef} placeholder="Desc"/>
                <input image="image" type="text" ref={this.imageRef} placeholder="Image"/>
                <button type="submit">Add Fish <span role="img" aria-label="image">🐟</span></button>
            </form>
        );
    }
}
